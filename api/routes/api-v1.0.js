...
router.get('/classitem-detail',Class.classitem_detail);   //获取课程详情
router.get('/classitem-reward',Class.classitem_reward);   //获取课程打赏状态
...
router.post('/question-unassist',Question.question_unassist);   //问题点赞
//广告
...
router.post('/set-mygroupuser',Groupuser.set_mygroupuser); //秀爱群组成员
router.post('/set-mygroup',Group.set_mygroup); //设置我的群组
router.get('/get-groupbyid',Group.get_groupbyid); //设置我的群组
//投诉
router.post('/set-complaint',Complaint.set_complaint); //获取我的群组

//配置
router.get('/get-init-config',Config.get_init_config); //获取群组成员
//短信
...
router.get('/get-payordersbyid',Pay.get_payordersbyid); //获取微信打赏排名
