...
//课程
router.get('/get-home',Class.home);   //获取产品列表
router.get('/splendid-video',Class.splendid_video);   //获取产品列表
...
router.get('/questionlist-outside',Question.questionlist_outside);   //无身份时提交提问
...
router.get('/get-weixingopenid',Pay.get_weixingopenid); //获取openid
