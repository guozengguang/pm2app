...
module.exports={
  list:function (req,res) {
    ...
    models.Activity.findAll({
      ...
      attributes:[['activity_id','id'],['activity_title','title'],['activity_img','img'],['activity_address','address'],['activity_official','official'],['activity_link','link'],['activity_stime','stime'],['activity_etime','etime']]
    }).then(function (data) {
