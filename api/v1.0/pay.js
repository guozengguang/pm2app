...
var  Pay={
  ...
  return string;
   ...
   var content={};
    ...
    models.Payorder.findAll({
      ...
      limit:10,
      attributes:['payorderid','po_money','po_openid','po_nickname','po_headimgurl','po_city']
    }).then(function(item){
        var data ={
  ...
  },get_payordersbyid:function(req,res){
    var body=req.query;
    if(!body.mid){
      return response.ApiError(res,{message:'mid empty'})
    }
    ...
    var totalmoney = 0;
    models.Payorder.Payorderbyid({
      where:{mid:body.mid},
       attributes:['po_toname','po_nickname','money_sum','po_headimgurl']
    }).then(function(item){
