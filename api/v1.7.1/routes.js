...
router.get(VSERION+'get-insidemembers',Members.get_insidemembers);   //内部员工列表
...
router.get(VSERION+'goods-classlist',Class.goods_classlist);   //获取产品详情
router.get(VSERION+'class-detail',Class.class_detail);   //获取课程详情
router.get(VSERION+'class-reward',Class.class_reward);   //获取课程打赏状态
...
router.get(VSERION+'get-courseware',Class.get_courseware);   //获取课件
router.get(VSERION+'get-reference',Class.get_reference);   //获取推荐书目
router.get(VSERION+'goodsrelated-detail',Class.goodsrelated_detail);   //获取新的产品详情
router.get(VSERION+'goods-mediaattach',Class.goods_mediaattach);   //获取新的产品详情

//提问
router.get(VSERION+'question-list',Config.get_vote,Question.list);   //获取问题列表
router.get(VSERION+'question-my',Question.question_my);   //获取我的问题 投票
router.get(VSERION+'question-vote',Question.question_vote);   //获取我的问题 投票
...
router.post(VSERION+'question-unassist',Config.get_vote,Question.question_unassist);   //问题点赞
//广告
...
router.get(VSERION+'get-groupbyid',Group.get_groupbyid); //根据id获取群组详情
router.get(VSERION+'get-groupbygood',Group.get_groupbygood); //获取产品下的群组
router.get(VSERION+'get-groupuserbygood',Groupuser.get_groupuserbygood); //获取产品下的用户
router.get(VSERION+'get-groupbyusertype',Group.get_groupbyusertype); //获取院长本院群组
//投诉
router.post(VSERION+'set-complaint',Complaint.set_complaint); //设置我的投诉

//配置
router.get(VSERION+'get-init-config',Config.get_init_config); //获取配置信息
//短信
...
//栏目
router.get(VSERION+'get-columnsbyid',Column.get_columnsbyid); //获取栏目列表
//媒咨
router.get(VSERION+'get-mediasbycolumnid',Media.get_mediasbycolumnid); //获取栏目下的媒咨
router.get(VSERION+'get-mediabyid',Media.get_mediabyid); //获取媒咨详情
router.get(VSERION+'get-video',Media.get_video); //一个视频
